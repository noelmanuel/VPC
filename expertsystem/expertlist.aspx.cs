...
public partial class expertsystem_expertlist : System.Web.UI.Page
{
    ...
    private void bindata()
    {
        ...
        string insertQuery = "select * from expert";
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("expertdes.aspx?id=" + e.CommandArgument.ToString());
        }
    }
