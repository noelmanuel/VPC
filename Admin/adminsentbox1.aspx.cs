...
public partial class Admin_adminsentbox1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string insertQuery = "select * from recompmessage";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Select")
        {
            ...
            string insertQuery = "select message from recompmessage where userr='" + pro1 + "' AND Id='" + pro + "'";
            SqlCommand cmdqw = new SqlCommand(insertQuery, conn);
            SqlDataReader readerqw = cmdqw.ExecuteReader();
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string str2 = "delete from recompmessage where Id='" + compname.Text + "' AND userr='" + Session["comp"].ToString() + "'";
        SqlCommand cmd = new SqlCommand(str2, conn);
        cmd.ExecuteNonQuery();
        Response.Write(" <script>window.alert('Message Deleted'); window.location='adminsentbox1.aspx';</script>");
        conn.Close();
