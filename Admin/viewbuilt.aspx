...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="height:790px;margin-left:5%;">
        ...
        <div style="overflow:scroll; width:1570px; height:350px;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderWidth="1px" CellPadding="4" BorderStyle="None" Height="196px" Width="1530px" OnRowDeleting="GridView1_RowDeleting">
            <Columns>
        ...
        <table style=" border:1px solid #e4e4e4;">
            <tr>
                <td>
                    ...
                    <asp:DropDownList ID="DropDownList2" Width="250px" CssClass="drd" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="productid" DataValueField="productid"></asp:DropDownList><br /><br /><br />
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT [productid] FROM [cpubuildmb]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td style=" border:1px solid #e4e4e4; ">
                    ...
                    <asp:DropDownList ID="DropDownList1" Width="250px" DataTextField="Ram" DataValueField="Ram" CssClass="drd" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource3"></asp:DropDownList><br /><br /><br />
                ...
                <td  style=" border:1px solid #e4e4e4;">
                    ...
                    <asp:DropDownList ID="DropDownList3" Width="250px" DataTextField="GPU" DataValueField="GPU" CssClass="drd" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource4"></asp:DropDownList><br /><br /><br />
                ...
                <td  style=" border:1px solid #e4e4e4;">
                    ...
                    <asp:DropDownList ID="DropDownList4" Width="250px" DataTextField="Casee" DataValueField="Casee" CssClass="drd" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource5"></asp:DropDownList><br /><br /><br />
                ...
                <td  style=" border:1px solid #e4e4e4;">
                    ...
                    <asp:DropDownList ID="DropDownList5" Width="250px" DataTextField="Processor" DataValueField="Processor" CssClass="drd" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource6"></asp:DropDownList><br /><br /><br />
                ...
                <td  style=" border:1px solid #e4e4e4;">
                    ...
                    <asp:DropDownList ID="DropDownList6" Width="250px" CssClass="drd" DataTextField="smps" DataValueField="smps" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource7"></asp:DropDownList><br /><br /><br />
