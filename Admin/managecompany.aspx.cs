...
public partial class Admin_managecompany : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string str1 = "update compregn set compname='" + name.Text + "',comppass='" + password.Text + "',compweb='" + birthday.Text + "',comploc='" + gender.Text + "',compemail='" + email.Text + "',compphone='" + phone.Text + "',compques='" + ques.Text + "',compans='" + ans.Text + "',status='" + status.Text + "' where compusname='" + username.Text + "'";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string str3 = "delete from compregn where compusname='" + usernamee.Text + "'";
        conn.Open();
        SqlCommand cmd = new SqlCommand(str3, conn);
        cmd.ExecuteNonQuery();
        conn.Close();
        Response.Write(" <script>window.alert('User Deleted'); window.location='managecompany.aspx';</script>");
    }
}