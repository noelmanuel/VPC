...
public partial class Admin_Product_admin_addprocessor : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (reader1.HasRows)
        {
            Response.Write(" <script>window.alert('Product Already Exist'); window.location='addprocessor.aspx';</script>");
        }
        else
        {
            reader1.Close();
