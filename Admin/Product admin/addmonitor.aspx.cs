...
public partial class Admin_Product_admin_addmonitor : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (reader1.HasRows)
        {
            Response.Write(" <script>window.alert('Product Already Exist'); window.location='addmonitor.aspx';</script>");
        }
        else
        {
            reader1.Close();
            ...
            string insertQuery = "insert into monitor(man,mod,par,scr,rec,wid,aspe,vie,dis,bri,contr,res,refr,pan,led,bui,dvi,hdm,imageurl,pric,imageurl1,imageurl2,stock) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "','" + TextBox12.Text + "','" + TextBox13.Text + "','" + TextBox14.Text + "','" + TextBox15.Text + "','" + TextBox16.Text + "','" + TextBox17.Text + "','" + TextBox18.Text + "','" + link + "','" + TextBox19.Text + "','" + link2 + "','" + link3 + "','" + TextBox20.Text + "')";
