...
public partial class Admin_companyadmininbox : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string insertQuery = "select * from compmessage";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Select")
        {
            ...
            string insertQuery = "select message from compmessage where userr='" + pro1 + "' AND Id='" + pro + "'";
            SqlCommand cmdqw = new SqlCommand(insertQuery, conn);
            SqlDataReader readerqw = cmdqw.ExecuteReader();
        ...
        else if (e.CommandName == "Insert")
        {
            ...
            string ordp = "insert into recompmessage(userr,name,message) values('" + pro1 + "','" + pro2 + "','" + TextArea2.Value + "')";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        Response.Write(" <script>window.alert('Message Deleted'); window.location='companyadmininbox.aspx';</script>");
        conn.Close();
