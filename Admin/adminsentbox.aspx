<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminmaster.master" AutoEventWireup="true" CodeFile="adminsentbox.aspx.cs" Inherits="Admin_adminsentbox" %>
    ...
    <div style="height:870px; margin-left:185px;">
        ...
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="16" Font-Underline="False" Font-Overline="False" ForeColor="Red"></asp:Label>
         ...
         <div style=" overflow:scroll; height:500px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [remessage]">
            </asp:SqlDataSource>
        </div>
