<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminmaster.master" AutoEventWireup="true" CodeFile="companyadmininbox.aspx.cs" Inherits="Admin_companyadmininbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="height:870px; margin-left:185px;">
        <h3 style="">INBOX</h3>
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="16" ForeColor="Red"></asp:Label>
        <div style=" overflow:scroll; height:500px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [userr], [name], [Id] FROM [compmessage]"></asp:SqlDataSource>
        </div>
        <table>
            <tr>
