<%@ Page Title="" Language="C#" MasterPageFile="~/User/usermaster.master" AutoEventWireup="true" CodeFile="msginbox.aspx.cs" Inherits="User_msginbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="height:870px; margin-left:185px;">
        ...
        <div style=" overflow:scroll; height:500px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [remessage1] WHERE ([userr] = @userr)">
                <SelectParameters>
