<%@ Page Title="" Language="C#" MasterPageFile="~/User/usermaster.master" AutoEventWireup="true" CodeFile="buildorders.aspx.cs" Inherits="User_buildorders" %>
                            ...
                            <tr>
                               <td style="height:100px;" class="auto-style1">
                                ...
                                <td style="height:100px;" class="auto-style1">
                                 ...
                                 <td style="height:100px;" class="auto-style1">
                                   <span class="sp">Address</span><br />
                                   <asp:Label ID="Label3" runat="server" Text='<%# Eval("addr1") %>'></asp:Label>
                               </td>
