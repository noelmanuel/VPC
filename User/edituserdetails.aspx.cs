...
public partial class User_edituserdetails : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string str1 = "update cregn set uname='" + name.Text + "',uspass='" + password.Text + "',usbday='" + birthday.Text + "',usgen='" + gender.Text + "',email='" + email.Text + "',usphone='" + phone.Text + "' where usname='" + username.Text + "'";
        ...
        conn.Close();
        Response.Write(" <script>window.alert('Details modified'); window.location='edituserdetails.aspx';</script>");
    }
