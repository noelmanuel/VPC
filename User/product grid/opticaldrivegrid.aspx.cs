...
public partial class User_product_grid_opticaldrivegrid : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter Adp = new SqlDataAdapter("select man,pric from cddrive", conn);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            if (reader21.HasRows)
            {
                ...
                string ordp = "insert into makecart(userr,product,mb,mbprice,mbslot,gpuslot,opticaldrive,opticaldriveprice) values('" + Session["user"].ToString() + "','optical drive','" + no + "','" + gputot4 + "','" + gputot3 + "','" + gputot + "','" + pro.Text + "','" + pri + "')";
        ...
        else if (e.CommandName == "Insert")
        {
            ...
            string gg = "select * from cddrive where man='" + pro.Text + "'";
