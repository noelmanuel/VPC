<%@ Page Title="" Language="C#" MasterPageFile="~/User/usermaster.master" AutoEventWireup="true" CodeFile="mousegrid.aspx.cs" Inherits="User_product_grid_mousegrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="section_backgound">
        ...
        <h3 style="padding-top:17px; margin-left:10%;">SELECT MOUSE</h3>
    <asp:GridView ID="GridView1" CssClass="gridd" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="5" CellSpacing="3" Width="843px" OnRowCommand="GridView1_RowCommand" >
        <Columns>
            <asp:TemplateField HeaderText="Mouse Brand">
                <ItemTemplate>
     ...
     <asp:Panel ID="Panel1" runat="server">
      ...
      <h3 style="padding-top:20px;">MOUSE DETAILS</h3>
