    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (readertest.HasRows)
        {
            ...
            if (readertest1.HasRows)
            {
                ...
                SqlDataAdapter Adp = new SqlDataAdapter("select Processor,Price from cpubuildpro where productid='" + notest1 + "'", conn);
            ...
            {
                Response.Write(" <script>window.alert('No Compactiable Processor Found');</script>");
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            if (reader21.HasRows)
            {
                ...
                string ordp = "insert into makecart(userr,product,mb,mbprice,mbslot,gpuslot,pro,proprice) values('" + Session["user"].ToString() + "','processor','" + no + "','" + gputot4 + "','" + gputot3 + "','" + gputot + "','" + pro.Text + "','" + pri + "')";
        ...
        else if (e.CommandName == "Insert")
        {
            ...
            string gg = "select * from processor where man='" + pro.Text + "'";
