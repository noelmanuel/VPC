...
public partial class User_product_grid_smpsgrid : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter Adp = new SqlDataAdapter("select DISTINCT powerr,powerp from cpubuild", conn);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            string ordp = "insert into makecart(userr,product,powerr,powerprice) values('" + Session["user"].ToString() + "','smps','" + pro.Text + "','" + pri + "')";
