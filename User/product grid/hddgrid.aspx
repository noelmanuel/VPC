<%@ Page Title="" Language="C#" MasterPageFile="~/User/usermaster.master" AutoEventWireup="true" CodeFile="hddgrid.aspx.cs" Inherits="User_product_grid_hddgrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="section_backgound">
        ...
        <h3 style="padding-top:17px; margin-left:10%;">SELECT HDD</h3>
    ...
    <asp:GridView ID="GridView1" CssClass="gridd" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="5" CellSpacing="3" Width="843px" OnRowCommand="GridView1_RowCommand" >
     ...
     <asp:Panel ID="Panel1" runat="server">
      ...
      <h3 style="padding-top:20px;">HARDDISK DETAILS</h3>
         ...
         <h3 style="">NOTE:</h3>
         <asp:Label ID="Label23" Font-Bold="true"  ForeColor="#006600"   runat="server" >If you wish to have more storage then you can buy them individually</asp:Label>
