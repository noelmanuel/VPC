...
public partial class User_product_grid_casegrid : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (readertest.HasRows)
        {
            ...
            if (readertest1.HasRows)
            {
                ...
                SqlDataAdapter Adp = new SqlDataAdapter("select Casee,Price from cpubuildcase where productid='" + notest1 + "'", conn);
            ...
            {
                Response.Write(" <script>window.alert('No Compactiable Case Found');</script>");
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            if (reader21.HasRows)
            {
                ...
                string ordp = "insert into makecart(userr,product,mb,mbprice,mbslot,gpuslot,casee,caseprice) values('" + Session["user"].ToString() + "','case','" + no + "','" + gputot4 + "','" + gputot3 + "','" + gputot + "','" + pro.Text + "','" + pri + "')";
        ...
        else if (e.CommandName == "Insert")
        {
            ...
            string gg = "select * from casee where man='" + pro.Text + "'";
