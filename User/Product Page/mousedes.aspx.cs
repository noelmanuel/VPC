...
public partial class User_Product_Page_mousedes : System.Web.UI.Page
{
    ...
    private void dig()
    {
        foreach (DataListItem dli in DataList1.Items)
        {
            ...
            conn.Close();
            Response.Write(" <script>window.alert('ADDED TO CART');window.location='mouselist.aspx';</script>");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        foreach (DataListItem dli in DataList1.Items)
        {
            ...
            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
            string insertQuery = "select stock from mouse where mod = '" + Label2.Text + "'";
