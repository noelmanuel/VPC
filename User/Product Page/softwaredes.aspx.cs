...
public partial class User_Product_Page_softwaredes : System.Web.UI.Page
{
    ...
    private void dig()
    {
        foreach (DataListItem dli in DataList1.Items)
        {
            ...
            conn.Close();
            Response.Write(" <script>window.alert('ADDED TO CART');window.location='caselist.aspx';</script>");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        foreach (DataListItem dli in DataList1.Items)
        {
            ...
            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
            string insertQuery = "select stock from software where mod = '" + Label2.Text + "'";
