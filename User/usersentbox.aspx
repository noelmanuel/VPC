<%@ Page Title="" Language="C#" MasterPageFile="~/User/usermaster.master" AutoEventWireup="true" CodeFile="usersentbox.aspx.cs" Inherits="User_usersentbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="height:870px; margin-left:185px;">
        <h3 style="">SENT MAIL</h3>
         <asp:Label ID="Label6" runat="server" Font-Bold="True" ForeColor="Red" Font-Size="16"></asp:Label>
        <div style=" overflow:scroll; height:500px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" Width="1145px" OnRowDeleting="GridView1_RowDeleting" CellPadding="4" ForeColor="#333333" GridLines="None">
                 ...
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="Transaction type">
                         <ItemTemplate>
                             <asp:Label ID="Label4" runat="server" Text='<%# Eval("transaction_type") %>'></asp:Label>
                         </ItemTemplate>
                         <ItemStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Transaction No">
                         <ItemTemplate>
                             <asp:Label ID="Label5" runat="server" Text='<%# Eval("transaction_no") %>'></asp:Label>
                         </ItemTemplate>
                         <ItemStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [message] WHERE ([userr] = @userr)">
                <SelectParameters>
