...
public partial class Company_addcomcompact : System.Web.UI.Page
{
    ...
    {
        Response.Write(" <script>window.alert('Build with your own products and dont build any incompatiable build thus resulting in ban');</script>");
    }
