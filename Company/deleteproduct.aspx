<%@ Page Title="" Language="C#" MasterPageFile="~/Company/company.master" AutoEventWireup="true" CodeFile="deleteproduct.aspx.cs" Inherits="Company_deleteproduct" %>
         ...
         <div style="padding-top:5px;">
           ...
           <asp:Panel ID="Panel1" CssClass="pan" runat="server">
               ...
               <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [motherboard] WHERE ([brand] = @brand)">
                       <SelectParameters>
             ...
             <asp:Panel ID="Panel2" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [ram] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel3" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [processor] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel4" CssClass="pan" runat="server">
                 ...
                 <div style="overflow:scroll; height:250px;">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [gpu] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel5" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [cddrive] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel6" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [smps] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel7" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [hdd] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel8" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [soundcard] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel9" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [ssd] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel10" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [cooler] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel11" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:GridView ID="GridView11" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource11" Width="763px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [casee] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel12" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [net] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel13" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource13" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [keyboard] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel14" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource14" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [mouse] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel15" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource15" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [monitor] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel16" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:GridView ID="GridView16" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource16" Width="763px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource16" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [speaker] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel17" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:GridView ID="GridView17" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource17" Width="763px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource17" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [ups] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel18" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource18" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [os] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel19" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:GridView ID="GridView19" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource19" Width="763px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource19" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [software] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel20" CssClass="pan" runat="server">
                 <div style="overflow:scroll; height:250px;">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource20" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [man], [pric], [mod] FROM [casefan] WHERE ([brand] = @brand)">
                       <SelectParameters>
                           <asp:SessionParameter Name="brand" SessionField="comp" Type="String" />
                       </SelectParameters>
                   </asp:SqlDataSource>
