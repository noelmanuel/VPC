...
public partial class Company_Product_company_comaddcasefan : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (reader1.HasRows)
        {
            Response.Write(" <script>window.alert('Product Already Exist'); window.location='comaddcasefan.aspx';</script>");
        }
        else
        {
            reader1.Close();
            ...
            cmd.ExecuteNonQuery();
            conn.Close();
            Response.Write(" <script>window.alert('Case fan added'); window.location='comaddcasefan.aspx';</script>");
        }
    }
