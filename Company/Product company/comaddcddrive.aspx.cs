...
public partial class Company_Product_company_comaddcddrive : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (reader1.HasRows)
        {
            Response.Write(" <script>window.alert('Product Already Exist'); window.location='comaddcddrive.aspx';</script>");
        }
        else
        {
            reader1.Close();
