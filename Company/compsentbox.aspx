<%@ Page Title="" Language="C#" MasterPageFile="~/Company/company.master" AutoEventWireup="true" CodeFile="compsentbox.aspx.cs" Inherits="Company_compsentbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div style="height:950px;"> 
        ...
        <div style=" overflow:scroll; height:500px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [compmessage1] WHERE ([userr] = @userr)">
                <SelectParameters>
