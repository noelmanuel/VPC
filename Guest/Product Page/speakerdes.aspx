<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="speakerdes.aspx.cs" Inherits="Guest_Product_Page_speakerdes" %>
    ...
    <div class="section_backgound">
        ...
        <ItemTemplate>
            <table class="cata_comp">
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Speaker" Visible="false"></asp:Label></td>
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("con") %>'></asp:Label>&nbsp&nbsp|
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("tot") %>'></asp:Label><br /><br />
