...
public partial class Guest_Product_Page_upslist : System.Web.UI.Page
{
    ...
    private void brand()
    {
        ...
        conn.Open();
        string brand = "select DISTINCT brand from ups";
    ...
    private void brad()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from ups WHERE brand='" + DropDownList1.SelectedItem + "'";
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("upsdes.aspx?id=" + e.CommandArgument.ToString());
        }
    }
