<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="gpudes.aspx.cs" Inherits="Guest_Product_Page_gpudes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">GPU SPECIFICATIONS</h3></div><br />
                        ...
                        <span class="sp">Chipset</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("chi") %>'></asp:Label><br /><br />
                        <span class="sp">Memory Size</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("mem") %>'></asp:Label><br /><br />
                        <span class="sp">Memory Type</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("memtyp") %>'></asp:Label><br /><br />
                        <span class="sp">Core Clock</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("cor") %>'></asp:Label><br /><br />
                        <span class="sp">Boost Clock</span><br />
                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("boo") %>'></asp:Label><br /><br />
                        
                     </td> 
                    <td class="auto-style2">
                        <span class="sp">TDP</span><br />
                        <asp:Label ID="Label10" runat="server" Text='<%# Eval("tdp") %>'></asp:Label><br /><br />
                        <span class="sp">Fan</span><br />
                        <asp:Label ID="Label11" runat="server" Text='<%# Eval("fan") %>'></asp:Label><br /><br />
                        <span class="sp">SLI Support</span><br />
                        <asp:Label ID="Label16" runat="server" Text='<%# Eval("sli") %>'></asp:Label><br /><br />
                        <span class="sp">Crossfire Support</span><br />
                        <asp:Label ID="Label17" runat="server" Text='<%# Eval("cro") %>'></asp:Label><br /><br />
                        <span class="sp">Length</span><br />
                        <asp:Label ID="Label18" runat="server" Text='<%# Eval("len") %>'></asp:Label><br /><br />
                        <span class="sp">Support Freesync</span><br />
                        <asp:Label ID="Label19" runat="server" Text='<%# Eval("sup") %>'></asp:Label><br /><br />
                        <span class="sp">DVI-D Dual Link</span><br />
                        <asp:Label ID="Label20" runat="server" Text='<%# Eval("dvi") %>'></asp:Label><br /><br />
                        <span class="sp">Displayport</span><br />
                        <asp:Label ID="Label23" runat="server" Text='<%# Eval("dis") %>'></asp:Label><br /><br />
                        <span class="sp">HDMI</span><br />
                        <asp:Label ID="Label24" runat="server" Text='<%# Eval("hdm") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="GPU" Visible="false"></asp:Label></td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [gpu] WHERE ([gpuid] = @gpuid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="gpuid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
