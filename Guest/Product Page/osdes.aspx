<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="osdes.aspx.cs" Inherits="Guest_Product_Page_osdes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">OS SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("ver") %>'></asp:Label><br /><br />
                        <span class="sp">Mode</span><br />
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("modee") %>'></asp:Label><br /><br />
                        <span class="sp">Maximum Supported Memory</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("maxi") %>'></asp:Label><br /><br />
                     </td> 
                    <td class="auto-style2">
                ...
                <tr>
                    ...
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("ver") %>'></asp:Label>&nbsp&nbsp|
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("modee") %>'></asp:Label><br /><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [os] WHERE ([osid] = @osid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="osid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
