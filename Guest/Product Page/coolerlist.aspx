<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="coolerlist.aspx.cs" Inherits="Guest_Product_Page_coolerlist" %>
            ...
            <tr>
                <td style="width:15%; padding:10px; border-left:1px solid #C07C05;">
                   <span class="spa">Price Filter</span><br /><br />
                    ...
                    <span class="spa">Radiator Size</span><br /><br />
                    <asp:DropDownList ID="DropDownList2" DataTextField="radi" DataValueField="radi" Height="30" Width="143" BorderColor="#E2E2E2" BorderStyle="Solid" runat="server"></asp:DropDownList>&nbsp
                    ...
                    <asp:DropDownList ID="DropDownList3" DataTextField="fan" DataValueField="fan" Height="30" Width="143" BorderColor="#E2E2E2" BorderStyle="Solid" runat="server"></asp:DropDownList>&nbsp
                ...
                <td style="width:85%; height:790px; border-left:1px solid #E2E2E2; ">
                    ...
                    <a href="coolerlist.aspx" style=""><h3 class="sd">CPU COOLER</h3></a>
                    ...
                    <ItemTemplate>
                        ...
                        <table class="item_bx">
                            ...
                            <tr>
                                <td class="auto-style5">
                                    <asp:Button ID="Button5" runat="server" Text="View Details" Width="250" ForeColor="White" BackColor="Red" BorderStyle="None" Height="30" CommandArgument='<%# Eval("coolerid") %>' CommandName="viewdetail" />
                                </td>
                            </tr>
