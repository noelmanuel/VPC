...
public partial class Guest_Product_Page_monitorlist : System.Web.UI.Page
{
    ...
    private void brand()
    {
        ...
        conn.Open();
        string brand = "select DISTINCT brand from monitor";
    ...
    private void socket()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string sock = "select DISTINCT scr from monitor";
    ...
    private void chipset()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string si = "select DISTINCT aspe from monitor";
    ...
    private void bindata()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        string insertQuery = "select * from monitor";
    ...
    private void loo()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inse = "select * from monitor WHERE Pric >= '" + TextBox1.Text + "' AND pric <= '" + TextBox2.Text + "'";
    ...
    private void brad()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from monitor WHERE brand='" + DropDownList1.SelectedItem + "'";
    ...
    private void soc()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from monitor WHERE scr='" + DropDownList2.SelectedItem + "'";
        SqlCommand cmdp = new SqlCommand(inp, conn);
        SqlDataAdapter dp = new SqlDataAdapter();
        dp.SelectCommand = cmdp;
    ...
    private void chip()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from monitor WHERE aspe='" + DropDownList3.SelectedItem + "'";
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("monitordes.aspx?id=" + e.CommandArgument.ToString());
        }
    }
