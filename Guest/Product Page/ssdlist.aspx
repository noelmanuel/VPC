<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="ssdlist.aspx.cs" Inherits="Guest_Product_Page_ssdlist" %>
            ...
            <tr>
                <td style="width:15%; padding:10px; border-left:1px solid #C07C05;">
                   <span class="spa">Price Filter</span><br /><br />
                    ...
                    <span class="spa">Capacity</span><br /><br />
                    <asp:DropDownList ID="DropDownList2" DataTextField="cap" DataValueField="cap" Height="30" Width="143" BorderColor="#E2E2E2" BorderStyle="Solid" runat="server"></asp:DropDownList>&nbsp
                    ...
                    <asp:DropDownList ID="DropDownList3" DataTextField="fac" DataValueField="fac" Height="30" Width="143" BorderColor="#E2E2E2" BorderStyle="Solid" runat="server"></asp:DropDownList>&nbsp
                ...
                <td style="width:85%; height:790px; border-left:1px solid #E2E2E2; ">
                    ...
                    <a href="ssdlist.aspx" style=""><h3 class="sd">SSD</h3></a>
                    ...
                    <ItemTemplate>
                        ...
                        <table class="item_bx">
                            ...
                            <tr>
                                <td class="auto-style5">
                                    <asp:Button ID="Button5" runat="server" Text="View Details" Width="250" ForeColor="White" BackColor="Red" BorderStyle="None" Height="30" CommandArgument='<%# Eval("ssdid") %>' CommandName="viewdetail" />
                                </td>
                            </tr>
