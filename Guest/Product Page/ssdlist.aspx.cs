...
public partial class Guest_Product_Page_ssdlist : System.Web.UI.Page
{
    ...
    private void brand()
    {
        ...
        conn.Open();
        string brand = "select DISTINCT brand from ssd";
    ...
    private void socket()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string sock = "select DISTINCT cap from ssd";
    ...
    private void chipset()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string si = "select DISTINCT fac from ssd";
    ...
    private void bindata()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        string insertQuery = "select * from ssd";
    ...
    private void loo()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inse = "select * from ssd WHERE Pric >= '" + TextBox1.Text + "' AND pric <= '" + TextBox2.Text + "'";
    ...
    private void brad()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from ssd WHERE brand='" + DropDownList1.SelectedItem + "'";
    ...
    private void soc()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from ssd WHERE cap='" + DropDownList2.SelectedItem + "'";
        SqlCommand cmdp = new SqlCommand(inp, conn);
        SqlDataAdapter dp = new SqlDataAdapter();
        dp.SelectCommand = cmdp;
    ...
    private void chip()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from ssd WHERE fac='" + DropDownList3.SelectedItem + "'";
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ssddes.aspx?id=" + e.CommandArgument.ToString());
        }
    }
