<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="smpsdes.aspx.cs" Inherits="Guest_Product_Page_smpsdes" %>
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">SMPS SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("typ") %>'></asp:Label><br /><br />
                        <span class="sp">Wattage</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("wat") %>'></asp:Label><br /><br />
                        <span class="sp">Modular</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("modu") %>'></asp:Label><br /><br />
                        <span class="sp">Efficency Certification</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("eff") %>'></asp:Label><br /><br />
                        <span class="sp">PCI-Express 6+2-PIN Connectors</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("pci") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Smps" Visible="false"></asp:Label></td>
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("typ") %>'></asp:Label>&nbsp&nbsp|
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("eff") %>'></asp:Label><br /><br />
