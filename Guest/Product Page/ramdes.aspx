<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="ramdes.aspx.cs" Inherits="Guest_Product_Page_ramdes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">RAM SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("memtyp") %>'></asp:Label><br /><br />
                        <span class="sp">Double Data Rate Type</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("ddr") %>'></asp:Label><br /><br />
                        <span class="sp">Frequency</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("fre") %>'></asp:Label><br /><br />
                        <span class="sp">Memory Size</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("siz") %>'></asp:Label><br /><br />
                        <span class="sp">Cas Latency</span><br />
                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("cas") %>'></asp:Label><br /><br />
                        <span class="sp">Timing</span><br />
                        <asp:Label ID="Label10" runat="server" Text='<%# Eval("tim") %>'></asp:Label><br /><br />
                        
                     </td> 
                    <td class="auto-style2">
                        
                        <span class="sp">Voltage</span><br />
                        <asp:Label ID="Label11" runat="server" Text='<%# Eval("vol") %>'></asp:Label><br /><br />
                        <span class="sp">Heat Spreader</span><br />
                        <asp:Label ID="Label16" runat="server" Text='<%# Eval("hea") %>'></asp:Label><br /><br />
                        <span class="sp">ECC</span><br />
                        <asp:Label ID="Label17" runat="server" Text='<%# Eval("ecc") %>'></asp:Label><br /><br />
                        <span class="sp">Registered</span><br />
                        <asp:Label ID="Label18" runat="server" Text='<%# Eval("regi") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Ram" Visible="false"></asp:Label></td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [ram] WHERE ([rId] = @rId)">
        <SelectParameters>
