...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">MONITOR SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("scr") %>'></asp:Label><br /><br />
                        <span class="sp">Recommended Resolution</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("rec") %>'></asp:Label><br /><br />
                        <span class="sp">Widescreen</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("wid") %>'></asp:Label><br /><br />
                        <span class="sp">Aspect Ratio</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("aspe") %>'></asp:Label><br /><br />
                        <span class="sp">Viewing Angle</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("vie") %>'></asp:Label><br /><br />
                        <span class="sp">Display Colors</span><br />
                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("dis") %>'></asp:Label><br /><br />
                        
                     </td> 
                    <td class="auto-style2">
                        <span class="sp">Brightness</span><br />
                        <asp:Label ID="Label10" runat="server" Text='<%# Eval("bri") %>'></asp:Label><br /><br />
                        <span class="sp">Contrast Ratio</span><br />
                        <asp:Label ID="Label11" runat="server" Text='<%# Eval("contr") %>'></asp:Label><br /><br />
                        <span class="sp">Response Time</span><br />
                        <asp:Label ID="Label16" runat="server" Text='<%# Eval("res") %>'></asp:Label><br /><br />
                        <span class="sp">Refresh Rate</span><br />
                        <asp:Label ID="Label17" runat="server" Text='<%# Eval("refr") %>'></asp:Label><br /><br />
                        <span class="sp">Panel Type</span><br />
                        <asp:Label ID="Label18" runat="server" Text='<%# Eval("pan") %>'></asp:Label><br /><br />
                        <span class="sp">LED</span><br />
                        <asp:Label ID="Label19" runat="server" Text='<%# Eval("led") %>'></asp:Label><br /><br />
                        <span class="sp">Build-In Speakers</span><br />
                        <asp:Label ID="Label20" runat="server" Text='<%# Eval("bui") %>'></asp:Label><br /><br />
                        <span class="sp">DVI</span><br />
                        <asp:Label ID="Label23" runat="server" Text='<%# Eval("dvi") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Monitor" Visible="false"></asp:Label></td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [monitor] WHERE ([monitorid] = @monitorid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="monitorid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
