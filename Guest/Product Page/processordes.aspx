<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="processordes.aspx.cs" Inherits="Guest_Product_Page_processordes" %>
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">PROCESSOR SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("wid") %>'></asp:Label><br /><br />
                        ...
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("cor") %>'></asp:Label><br /><br />
                        <span class="sp">Maximum Supported Memory</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("max") %>'></asp:Label><br /><br />
                        <span class="sp">L1 Cache</span><br />
                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("l1") %>'></asp:Label><br /><br />
                        
                     </td> 
                    <td class="auto-style2">
                        <span class="sp">L2 Cache</span><br />
                        <asp:Label ID="Label10" runat="server" Text='<%# Eval("l2") %>'></asp:Label><br /><br />
                        <span class="sp">L3 Cache</span><br />
                        <asp:Label ID="Label11" runat="server" Text='<%# Eval("l3") %>'></asp:Label><br /><br />
                        <span class="sp">Lithography</span><br />
                        <asp:Label ID="Label16" runat="server" Text='<%# Eval("lit") %>'></asp:Label><br /><br />
                        <span class="sp">Thermal Design Power</span><br />
                        <asp:Label ID="Label17" runat="server" Text='<%# Eval("the") %>'></asp:Label><br /><br />
                        <span class="sp">Include CPU Cooler</span><br />
                        <asp:Label ID="Label18" runat="server" Text='<%# Eval("inc") %>'></asp:Label><br /><br />
                        <span class="sp">Simultaneous Multithreading</span><br />
                        <asp:Label ID="Label19" runat="server" Text='<%# Eval("sim") %>'></asp:Label><br /><br />
                        <span class="sp">Integrated Graphics</span><br />
                        <asp:Label ID="Label20" runat="server" Text='<%# Eval("inte") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Processsor" Visible="false"></asp:Label></td>
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("soc") %>'></asp:Label>&nbsp&nbsp|
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("lit") %>'></asp:Label><br /><br />
