...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">SOUNDCARD SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("cha") %>'></asp:Label><br /><br />
                        <span class="sp">Interface</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("inte") %>'></asp:Label><br /><br />
                        <span class="sp">Digital Audio</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("dig") %>'></asp:Label><br /><br />
                        <span class="sp">Signal To Noise Ratio</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("sig") %>'></asp:Label><br /><br />
                        <span class="sp">Sample Rate</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("sam") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Soundcard" Visible="false"></asp:Label></td>
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("cha") %>'></asp:Label>&nbsp&nbsp|
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [soundcard] WHERE ([scid] = @scid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="scid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
