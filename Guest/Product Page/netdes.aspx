<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="netdes.aspx.cs" Inherits="Guest_Product_Page_netdes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">NETWORK CARD SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("inte") %>'></asp:Label><br /><br />
                        <span class="sp">Protocol</span><br />
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("pro") %>'></asp:Label><br /><br />
                        <span class="sp">Features</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("fea") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Network card" Visible="false"></asp:Label></td>
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("inte") %>'></asp:Label>&nbsp&nbsp|
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("pro") %>'></asp:Label><br /><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [net] WHERE ([netid] = @netid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="netid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
