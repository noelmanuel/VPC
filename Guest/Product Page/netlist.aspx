<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="netlist.aspx.cs" Inherits="Guest_Product_Page_netlist" %>
            ...
            <tr>
                <td style="width:15%; padding:10px; border-left:1px solid #C07C05;">
                   <span class="spa">Price Filter</span><br /><br />
                    ...
                    <asp:DropDownList ID="DropDownList2" DataTextField="inte" DataValueField="inte" Height="30" Width="143" BorderColor="#E2E2E2" BorderStyle="Solid" runat="server"></asp:DropDownList>&nbsp
                    <asp:Button ID="Button16" runat="server" Height="30" Width="50" Text="Go" ForeColor="White" BackColor="#C07C05" BorderStyle="None" OnClick="Button16_Click" /><br /><br /><br /><br />
                     ...
                     <span class="spa">Protocol</span><br /><br />
                    <asp:DropDownList ID="DropDownList3" DataTextField="pro" DataValueField="pro" Height="30" Width="143" BorderColor="#E2E2E2" BorderStyle="Solid" runat="server"></asp:DropDownList>&nbsp
                ...
                <td style="width:85%; height:790px; border-left:1px solid #E2E2E2; ">
                    ...
                    <a href="netlist.aspx" style=""><h3 class="sd">NETWORK CARD</h3></a>
                    ...
                    <ItemTemplate>
                        ...
                        <table class="item_bx">
                            ...
                            <tr>
                                <td class="auto-style5">
                                    <asp:Button ID="Button5" runat="server" Text="View Details" Width="250" ForeColor="White" BackColor="Red" BorderStyle="None" Height="30" CommandArgument='<%# Eval("netid") %>' CommandName="viewdetail" />
                                </td>
                            </tr>
