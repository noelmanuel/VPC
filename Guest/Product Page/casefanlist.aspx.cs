...
public partial class Guest_Product_Page_casefanlist : System.Web.UI.Page
{
    ...
    private void brand()
    {
        ...
        conn.Open();
        string brand = "select DISTINCT brand from casefan";
    ...
    private void socket()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string sock = "select DISTINCT mot from casefan";
    ...
    private void chipset()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string si = "select DISTINCT maxi from casefan";
    ...
    private void bindata()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        string insertQuery = "select * from casefan";
    ...
    private void loo()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inse = "select * from casefan WHERE Pric >= '" + TextBox1.Text + "' AND pric <= '" + TextBox2.Text + "'";
    ...
    private void brad()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from casefan WHERE brand='" + DropDownList1.SelectedItem + "'";
    ...
    private void soc()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from casefan WHERE mot='" + DropDownList2.SelectedItem + "'";
        SqlCommand cmdp = new SqlCommand(inp, conn);
        SqlDataAdapter dp = new SqlDataAdapter();
        dp.SelectCommand = cmdp;
    ...
    private void chip()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from casefan WHERE maxi='" + DropDownList3.SelectedItem + "'";
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("casefandes.aspx?id=" + e.CommandArgument.ToString());
        }
    }
