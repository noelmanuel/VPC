<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="keyboarddes.aspx.cs" Inherits="Guest_Product_Page_keyboarddes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">KEYBOARD SPECIFICATIONS</h3></div><br />
                        ...
                        <span class="sp">Design Style</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("des") %>'></asp:Label><br /><br />
                        <span class="sp">Type</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("typ") %>'></asp:Label><br /><br />
                        <span class="sp">Backlit</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("bac") %>'></asp:Label><br /><br />
                        <span class="sp">Mechanical</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("mec") %>'></asp:Label><br /><br />
                        <span class="sp">Include Mouse</span><br />
                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("inc") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Keyboard" Visible="false"></asp:Label></td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [keyboard] WHERE ([keyid] = @keyid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="keyid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
