<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="softwaredes.aspx.cs" Inherits="Guest_Product_Page_softwaredes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">SOFTWARE SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("typ") %>'></asp:Label><br /><br />
                        <span class="sp">Media Type</span><br />
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("med") %>'></asp:Label><br /><br />
                        <span class="sp">Supported Operating Systems</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("supp") %>'></asp:Label><br /><br />
                        <span class="sp">Features</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("fea") %>'></asp:Label><br /><br />
                ...
                <tr>
                    ...
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("med") %>'></asp:Label>&nbsp&nbsp|
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [software] WHERE ([softwareid] = @softwareid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="softwareid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
