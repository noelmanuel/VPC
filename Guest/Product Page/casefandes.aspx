<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="casefandes.aspx.cs" Inherits="Guest_Product_Page_casefandes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">CASE FAN SPECIFICATIONS</h3></div><br />
                        ...
                        <span class="sp">Size</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("typ") %>'></asp:Label><br /><br />
                        <span class="sp">Led color</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("inc") %>'></asp:Label><br /><br />
                        <span class="sp">Air flow</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("inte") %>'></asp:Label><br /><br />
                        <span class="sp">Noise level</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("inte1") %>'></asp:Label><br /><br />
                        <span class="sp">RPM</span><br />
                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("mot") %>'></asp:Label><br /><br />
                        
                     </td> 
                    <td class="auto-style2">
                        <span class="sp">Static pressure</span><br />
                        <asp:Label ID="Label10" runat="server" Text='<%# Eval("fro") %>'></asp:Label><br /><br />
                        <span class="sp">Bearing type</span><br />
                        <asp:Label ID="Label11" runat="server" Text='<%# Eval("maxi") %>'></asp:Label><br /><br />
                        <span class="sp">Features</span><br />
                        <asp:Label ID="Label16" runat="server" Text='<%# Eval("dime") %>'></asp:Label><br /><br />
                ...
                <tr>
                    ...
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("typ") %>'></asp:Label><br /><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [casefan] WHERE ([casefanid] = @casefanid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="casefanid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
