<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/usermaster.master" AutoEventWireup="true" CodeFile="hdddes.aspx.cs" Inherits="Guest_Product_Page_hdddes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">HARD DISK SPECIFICATIONS</h3></div><br />
                        ...
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("cap") %>'></asp:Label><br /><br />
                        ...
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("rpm") %>'></asp:Label><br /><br />
                        <span class="sp">Form Factor</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("fac") %>'></asp:Label><br /><br />
                        <span class="sp">GB/1</span><br />
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("gb") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="Hard disk" Visible="false"></asp:Label></td>
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("cap") %>'></asp:Label>&nbsp&nbsp|
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [hdd] WHERE ([hddid] = @hddid)">
        <SelectParameters>
            <asp:QueryStringParameter Name="hddid" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
        </div>
