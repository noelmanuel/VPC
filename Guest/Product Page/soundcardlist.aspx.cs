...
public partial class Guest_Product_Page_soundcardlist : System.Web.UI.Page
{
    ...
    private void brand()
    {
        ...
        conn.Open();
        string brand = "select DISTINCT brand from soundcard";
    ...
    private void socket()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string sock = "select DISTINCT cha from soundcard";
    ...
    private void chipset()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string si = "select DISTINCT inte from soundcard";
    ...
    private void bindata()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        string insertQuery = "select * from soundcard";
    ...
    private void loo()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inse = "select * from soundcard WHERE Pric >= '" + TextBox1.Text + "' AND pric <= '" + TextBox2.Text + "'";
    ...
    private void brad()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from soundcard WHERE brand='" + DropDownList1.SelectedItem + "'";
    ...
    private void soc()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from soundcard WHERE cha='" + DropDownList2.SelectedItem + "'";
        SqlCommand cmdp = new SqlCommand(inp, conn);
        SqlDataAdapter dp = new SqlDataAdapter();
        dp.SelectCommand = cmdp;
    ...
    private void chip()
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        conn.Open();
        string inp = "select * from soundcard WHERE inte='" + DropDownList3.SelectedItem + "'";
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("soundcarddes.aspx?id=" + e.CommandArgument.ToString());
        }
    }
