            ...
            <table class="cata_comp">
                <tr>
                    ...
                    <td class="auto-style2">
                        <div class="titl"><h3 style=" font-size:18px; padding-top:10px; color:#e7b93c;">SOLID STATE DRIVE SPECIFICATIONS</h3></div><br />
                        ...
                        <span class="sp">Form Factor</span><br />
                         <asp:Label ID="Label9" runat="server" Text='<%# Eval("fac") %>'></asp:Label><br /><br />
                        <span class="sp">Capacity</span><br />
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("cap") %>'></asp:Label><br /><br />
                        <span class="sp">Operating Temperature</span><br />
                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("ope") %>'></asp:Label><br /><br />
                ...
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="motherb" runat="server" Text="SSD" Visible="false"></asp:Label></td>
                    <td class="auto-stylee2">
                        ...
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("cap") %>'></asp:Label><br /><br />
